                ...
                <form action="{{ route('admin.posts.update', $post) }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="pb-4 px-4 flex space-x-4">
                        ...
                        <div class="w-full">
                            ...
                            <x-jet-input type="text" name="title_en" id="title_en" class="w-full py-1"
                                value="{{ $post->title_en }}"></x-jet-input>
                            @error('title_en')
                                <span class="text-xs text-red-600">{{ $message }}</span>
                            @enderror
                        </div>
                    ...
                    <div class="pb-4 px-4 flex space-x-4">
                        ...
                        <div class="w-full">
                            ...
                            <x-jet-input type="text" name="subtitle_en" class="w-full py-1" value="{{ $post->subtitle_en }}">
                            </x-jet-input>
                            @error('subtitle_en')
                                <span class="text-xs text-red-600">{{ $message }}</span>
                            @enderror
                    ...
                    <div class="pb-4 px-4">
                        ...
                        <textarea name="extract_en" id="extract" rows="7"
                            class="w-full border border-gray-200">{{ $post->extract_en }}</textarea>
                        @error('extract_en')
                            <span class="text-xs text-red-600">{{ $message }}</span>
                        @enderror
                    </div>
                    ...
                    <div class="pb-4 px-4">
                        ...
                        <textarea name="body_en" id="body_en" rows="7"
                            class="w-full border border-gray-200">{{ $post->body_en }}</textarea>
                        @error('body_en')
                            <span class="text-xs text-red-600">{{ $message }}</span>
                        @enderror
                    </div>
